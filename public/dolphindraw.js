(function() {
    ...
    PasciDraw.prototype.initUI = function() {
        ...
        drawingModeEl.onclick = function() {
            ...
            if (canvas.isDrawingMode) {
              drawingModeEl.innerHTML = 'Klieder mode';
              drawingOptionsEl.style.display = '';
            }
            else {
              drawingModeEl.innerHTML = 'Schuif-maar-raak mode';
        ...
        canvas.on('path:created', function(e) {
            socket.emit('path:created', JSON.stringify(e.path))
        })
